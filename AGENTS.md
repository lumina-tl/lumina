...
- Use JSDoc format for all block comments (e.g., function or method descriptions).
- Keep comments short, simple, and clear.
- Use brief inline comments (`//`) only for quick notes inside code blocks.
